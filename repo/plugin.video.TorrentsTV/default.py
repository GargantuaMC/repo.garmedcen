...
versionActual = plugintools.find_single_match(datosConf,'VersionTorrentsTV>(.*?)<Fin')

if versionActual > comparaVersion:
    try:
        cod1 = httptools.downloadpage(base64.b64decode("aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0FjZVRvcnIvZnV0dHJlYW0vbWFpbi9Ub3JyZW50c1RWX0RlZmF1bHQ=".encode('utf-8')).decode('utf-8')).data
    except:
        cod1 = httptools.downloadpage(base64.b64decode("aHR0cHM6Ly9yZW50cnkuY28vYmZxZmEvcmF3".encode('utf-8')).decode('utf-8')).data
