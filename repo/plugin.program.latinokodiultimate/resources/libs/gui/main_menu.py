...
class MainMenu:
    ...
    def get_listing(self):
        ...
        if tools.open_url(CONFIG.ADDONFILE, check=True) or os.path.exists(os.path.join(CONFIG.ADDON_PATH, 'resources', 'text', 'addons.json')):
            directory.add_dir('wizard LKU', {'mode': 'addons'}, icon=CONFIG.ICONADDONS, themeit=CONFIG.THEME1)
        directory.add_dir('wizard LKU', {'mode': 'saveda'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
