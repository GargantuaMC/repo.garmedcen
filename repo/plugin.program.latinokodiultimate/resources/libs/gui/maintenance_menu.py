...
class MaintenanceMenu:
    ...
    def clean_menu(self):
        ...
        directory.add_file('Borrar Old Thumbnails', {'mode': 'oldThumbs'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        directory.add_file('Borrar Crash Logs', {'mode': 'clearcrash'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        ...
        if autoclean == 'true':
            ...
            directory.add_file(
                '--- Borrar Old Thumbs en el Inicio: {0}'.format(thumbs.replace('true', on).replace('false', off)),
