...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR red]LKU Wizard[/COLOR] Matrix'
BUILDERNAME = 'Latino Kodi Matrix'
EXCLUDES = [ADDON_ID, '']
# Text File with build info in it.
BUILDFILE = 'https://buildlku.xyz/scattered/lkum.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]LKU [/B][/COLOR][COLOR {color2}]Wizard Matrix[COLOR {color1}]) [/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Gracias por elegir LKU.'
...
NOTIFICATION = 'https://github.com/latinokodi/latinokodi/raw/master/Mensaje.txt'
# Use either 'Text' or 'Image'
HEADERTYPE = 'Text'
# Font size of header
FONTHEADER = 'Font24'
HEADERMESSAGE = '[COLOR red][B]LEE ATENTAMENTE[/B][/COLOR]'
# url to image if using Image 424x180
HEADERIMAGE = 'http://'
# Font for Notification Window
FONTSETTINGS = 'Font20'
# Background for Notification Window
BACKGROUND = 'https://github.com/latinokodi/latinokodi/raw/master/back.jpg'
#########################################################
