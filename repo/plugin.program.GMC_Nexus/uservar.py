...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR yellow]GARGANTUA[COLOR gold] MultiVerse[COLOR white] [COLOR aqua]Config[COLOR yellow] Downloader[/COLOR]'
BUILDERNAME = 'Configurador GARGANTUA MultiVerse'
EXCLUDES = [ADDON_ID, 'plugin.program.GMC_Nexus']
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]GARGANTUA [/B][/COLOR][COLOR {color2}]MultiVerse[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = '[B][LOWERCASE][CAPITALIZE][COLOR lime]\r\n\r\nGracias por elegir GARGANTUA MultiVerse.[/COLOR][/CAPITALIZE][/LOWERCASE][/B]'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR yellow]Instalar [COLOR gold]config de[COLOR white] [COLOR aqua]GARGANTUA[COLOR yellow] MultiVerse[/COLOR]'
