...
if notify_mode == 'true': xbmc.executebuiltin('Notification(%s, %s, %s, %s)' % ('Estado de Mantenimiento',  'Paquetes: '+ str(total_sizetext) +  ' MB'  ' - Imagenes: ' + str(total_sizetext2) + ' MB' , '5000', iconpath))
time.sleep(3)
