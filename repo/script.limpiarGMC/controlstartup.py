...
##                pass
    ...
    xbmcgui.Dialog().notification('Limpia Tu Gargantúa' , 'Auto Limpieza[COLOR blue] Completada[/COLOR]' , iconpath, 3000)
...
def deleteThumbnails():
    ...
    try:
        ...
        pass
    dialog.ok("[COLOR=red]Atencion[/COLOR]", "Debe Reiniciar Gargantúa Para Aplicar los Cambios")
