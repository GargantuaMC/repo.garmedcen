...
iconpath = translatePath(os.path.join('special://home/addons/script.limpiarGMC','icon.png'))
...
xbmcgui.Dialog().notification('Limpiando Gargantúa',  'Paquetes: '+ str(total_sizetext) +  ' MB'  ' - Imagenes: ' + str(total_sizetext2) + ' MB' , iconpath, 5000)