...
icon3 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'luar.png'))
icon4 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'icon2.png'))
icon2 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'indigo.png'))
icon5 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'bibloteca.png'))
icon6 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'ltemp.png'))
icon7 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'paque.png'))
icon8 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'update.png'))
icon9 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'image.png'))
icon10 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'depen.png'))
icon11 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'Ajustes.png'))
icon12 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'respaldo.png'))
icon13 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'herra.png'))
icon14 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'depenico.png'))
icon15 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'Mante.png'))
icon16 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'Mante.png'))
icon17 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'lupa.png'))
icon18 = translatePath(os.path.join('special://home/addons/script.limpiarGMC/media' , 'gdrive.png'))
...
addonPath = os.path.join(os.path.join(translatePath('special://home'), 'addons'),'script.limpiarGMC')
mediaPath = os.path.join(addonPath, 'media')
databasePath = translatePath('special://database')
unoxdosPath = translatePath('special://home/addons/script.limpiarGMC')
...
def clearCache():
        ...
        if os.path.exists(clear_cache_path)==True:    
            for root, dirs, files in os.walk(clear_cache_path):
                ...
                if file_count > 0:
                    ...
                    dialog = xbmcgui.Dialog()
                    if dialog.yesno("Limpia Tu Gargantúa",str(file_count) + "%s Archivos Cache Encontrados[CR]Desea Eliminarlos?" %(entry.name)):
                        for f in files:
                            os.unlink(os.path.join(root, f))
                        for d in dirs:
                            shutil.rmtree(os.path.join(root, d))
    ...
    dialog = xbmcgui.Dialog()
    dialog.ok("Limpia Tu Gargantúa", "Todos los Archivos se Limpiaron con Exito")
...
def deleteThumbnails():
    ...
    if os.path.exists(thumbnailPath)==True:
            ...
            if choice1 == 1:
                ...
                choice2 =dialog.yesno("Limpia Tu Gargantúa", "Desea reiniciar Gargantúa ahora para terminar el proceso")
                if choice2 == 1:
                ...
                if dialog.yesno("Borrar Archivos en Temp", str(file_count) + " Archivos Encontrados[CR]Desea Eliminarlos?"):
                    ...
                    for d in dirs:
                        try:
                            ...
                            pass
        xbmcgui.Dialog().notification('Limpia Tu Gargantúa', "Archivos Temp Eliminados")
        ...
        for root, dirs, files in os.walk(purgePath):
            ...
            if file_count > 0:            
                ...
                for d in dirs:
                    shutil.rmtree(os.path.join(root, d))
                dialog = xbmcgui.Dialog()
                dialog.ok("Limpia Tu Gargantúa", "Borrar todo el contenido de Paquetes")
            else:
                dialog = xbmcgui.Dialog()
                dialog.ok("Limpia Tu Gargantúa", "Eliminados Paquetes")
...
def update():
        ...
        xbmcgui.Dialog().notification('Limpia Tu Gargantúa', "Repositorios & Addons[COLOR green]Actualizados[/COLOR]")
        try:
...
def deleteindigo():
    ...
    if os.path.exists(indigoPath)==True:    
        for root, dirs, files in os.walk(indigoPath):
            ...
            if file_count > 0:
                dialog = xbmcgui.Dialog()
                if dialog.yesno("Este Proceso Desinstala Indigo", str() + "Despues de desinstalar Indigo Gargantúa se  [COLOR red]reiniciara[/COLOR][CR]Esta seguro de que desea eliminar Indigo?"):
                ...
                xbmcgui.Dialog().notification('Limpia Tu Gargantúa', "Indigo [COLOR green] Desinstalado[/COLOR]")
                pass
...
def deletegdrive():
    ...
    if os.path.exists(gdrivePath)==True:    
        for root, dirs, files in os.walk(gdrivePath):
            ...
            if file_count > 0:
                dialog = xbmcgui.Dialog()
                if dialog.yesno("Este Proceso Desinstala gdrive", str() + "Despues de desinstalar gdrive Gargantúa se  [COLOR red]reiniciara[/COLOR][CR]Esta seguro de que desea eliminar gdrive?"):
                ...
                xbmcgui.Dialog().notification('Limpia Tu Gargantúa', "gdrive [COLOR green] Desinstalado[/COLOR]")
                pass
...
def enableadaptive():
        ...
        xbmc.executebuiltin('XBMC.Notification(%s, %s, %s, %s)' % ('Limpia Tu Gargantúa' , 'Input Stream Adaptative[COLOR green] Instalado[/COLOR]' , '3000', icon))
...
def enablertmp():
        ...
        xbmc.executebuiltin('XBMC.Notification(%s, %s, %s, %s)' % ('Limpia Tu Gargantúa' , 'InputStream RTMP[COLOR green] Instalado[/COLOR]' , '3000', icon))
...
def compactDB():
    ...
    if os.path.exists(databasePath):
        ...
        d.create('Limpia Tu Gargantúa', "Iniciando... ")
        total = len(files)
        ...
        msg = "Se ha producido un error al compactar las  bases de datos.\n" \
              "Reinicie Gargantúa y vuelva a probar"
        logger(msg)

    xbmcgui.Dialog().ok('Limpia Tu Gargantúa', msg)
    return
...
def herram():
    ...
    addItem('  Limpiar Bibloteca Gargantúa', 'url', 12,icon5)
