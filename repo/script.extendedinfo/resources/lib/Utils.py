...
OPENMETA_TV_FOLDER = xbmcaddon.Addon('plugin.video.acmeplayer').getSetting('tv_library_folder') if xbmc.getCondVisibility('System.HasAddon(plugin.video.acmeplayer)') else None
OPENMETA_MOVIE_FOLDER = xbmcaddon.Addon('plugin.video.acmeplayer').getSetting('movies_library_folder') if xbmc.getCondVisibility('System.HasAddon(plugin.video.acmeplayer)') else None
